...
<img width="661" alt="Screenshot 2024-02-13 123908" <img width="233" alt="Screenshot 2024-02-13 1import tkinter
from tkinter import *
...
def Admin():
         ...
         if name=="root" and pwd=="root":
            ...
            def Ques_inf():
                ...
                def Insert_Question():
                    ...
                    m22=Canvas(m,width=1270,height=1080,bg='light blue')
                    m22.place(x=0,y=0)
                ...
                def Update_Questions():
                    ...
                    n22=Canvas(n,width=1270,height=1080,bg='light blue')
                    n22.place(x=0,y=0)
                ...
                def Delete_Questions():
                    ...
                    k10=Canvas(k,width=1270,height=1080,bg='light blue')
                    k10.place(x=0,y=0)
                ...
                def Find_Questions():
                    ...
                    l22=Canvas(l,width=1270,height=1080,bg='light blue')
                    l22.place(x=0,y=0)
                ...
                c2=Canvas(c,width=1070,height=1080,bg='light blue')
                c2.place(x=200,y=0)
            ...
            def User_info():
                ...
                def Insert_details():
                    ...
                    c11=Canvas(j,width=1270,height=1080,bg='light blue')
                    c11.place(x=0,y=0)
                ...
                def Update_details():
                    ...
                    c22=Canvas(k,width=1270,height=1080,bg='light blue')
                    c22.place(x=0,y=0)
                ...
                def Find_details():
                    ...
                    c33=Canvas(o,width=1270,height=1080,bg='light blue')
                    c33.place(x=0,y=0)
                ...
                def delete_data():
                    ...
                    c334=Canvas(q,width=1270,height=1080,bg='light blue')
                    c334.place(x=0,y=0)
            ...
            c2=Canvas(a,width=1270,height=1080,bg='light blue')
            c2.place(x=0,y=0)
     ...
     c1=Canvas(b,width=1270,height=1080,bg='light blue')
     c1.place(x=0,y=0)
...
def User():
    ...
    def Login_2():
        ...
        if result is not None and name==result[0] and password==result[1]:
            ...
            def computer():
                ...
                score_lbl.place(x=1100,y=80)
                # closebt=Button(t,text="CLOSE",width=10,height=2,bg="yellow",command=closeall)
                # closebt.place(x=900,y=500)
            ...
            h11=Canvas(h1,width=1270,height=1080,bg='light blue')
            h11.place(x=0,y=0)
    ...
    z4=Canvas(z,width=1270,height=1080,bg='light blue')
    z4.place(x=0,y=0)
...
c=Canvas(t,width=1270,height=1080,bg='light blue')
c.place(x=0,y=0)
...
t.mainloop()23609" <img width="876" alt="Screenshot 2024-02-13 123655" src="https://github.com/abhinavverma459/Quiz_Portal_System_software_by_Python_and_MySQL/assets/140261892/9b10ceee-f75d-4f15-9157-6e9192345370">
src="https://github.com/abhinavverma459/Quiz_Portal_System_software_by_Python_and_MySQL/assets/140261892/f2017d68-cc4c-467a-aeb8-c2536c0d4288">
src="https://github.com/abhinavverma459/Quiz_Portal_System_software_by_Python_and_MySQL/assets/140261892/63f10aec-bd31-4305-b5e7-954b7dcddf78">
<img width="251" alt="Screenshot 2024-02-13 123741" src="https://github.com/abhinavverma459/Quiz_Portal_System_software_by_Python_and_MySQL/assets/140261892/49258ed3-e8f5-46d4-8690-af80991d3d9e">
